<p className="text-xs text-gray-400">(Image by NASA @Unsplash)</p>

**The Challenge: Handling 10K+ Assets on a Map**

At work, I was tasked with improving the performance of our web application’s interactive
map. The existing implementation used Leaflet, but as our dataset grew to 10K+ assets
with complex connections, user interactions such as panning and zooming became sluggish,
